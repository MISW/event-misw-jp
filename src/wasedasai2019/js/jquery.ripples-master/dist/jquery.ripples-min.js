  ...
  (c.DEFAULTS = {
    ...
    (c.prototype = {
        ...
        if (
          ('fixed' == o
            ? (((e = {
              ...
              (e.height = u.height()))
            : (((e = this.$el.offset()).width = this.$el.innerWidth()), (e.height = this.$el.innerHeight())),
          'cover' == i)
        )
      ...
      hideCssBackground: function () {
        ...
        'none' != e &&
          ((this.originalInlineCss = e), (this.originalCssBackgroundImage = this.$el.css('backgroundImage')), this.$el.css('backgroundImage', 'none'));
      },
